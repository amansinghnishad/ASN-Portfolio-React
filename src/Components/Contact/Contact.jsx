  ...
  return (
    <>
      <div className="  w-full h-96 flex justify-center item-center mb-5  ">
        <div className=" grid grid-cols-3 m-2 w-9/20  justify-center items-center border-[#1f0741] hover:drop-shadow-[25px_25px_25px_rgba(31,7,65,0.77)] shadow-[rgba(31,7,65,0.77)] bg-gradient-to-br from-[#a073d1cb] to-[#0b0217d5] rounded-xl border-2 h-full overflow-hidden">
          ...
          <div className="h-full w-full flex flex-col">
            ...
            <div className="w-full h-full flex justify-end items-end overflow-hidden  hover:skew-y-6">
