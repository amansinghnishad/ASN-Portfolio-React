...
const GlassPanel = ({ as: Component, className, children }) => {
  const baseClass =
    "glass-panel relative overflow-hidden rounded-3xl border border-borderSubtle bg-surface px-4 py-3 shadow-glass backdrop-blur-2xl transition-all duration-500 sm:px-6 sm:py-4";
